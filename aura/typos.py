...
from typing import Optional, Generator, Iterable, Tuple, Callable, List, Dict
...
def diff_distance(s1: str, s2: str, cutoff=0.8, cut_return=None):
    """
    ...
    """
    s: difflib.SequenceMatcher = difflib.SequenceMatcher()
    s.set_seq1(s1)
    s.set_seq2(s2)
